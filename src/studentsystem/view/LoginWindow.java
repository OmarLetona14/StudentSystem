...
import studentsystem.list.SimplyLinkedListSemester;
...
public class LoginWindow extends javax.swing.JFrame {
    ...
    public static SimplyLinkedListSemester listaSemestres = new SimplyLinkedListSemester();
    ...
    private void initComponents() {
        ...
        carneTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carneTxtActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(passwordTxt, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 206, Short.MAX_VALUE)
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if(ProfessorTableModel.professorsList.loginSerch(carneTxt.getText(), password)){
          currentProfessor = ProfessorTableModel.professorsList.getProfessorByCarnet(carneTxt.getText());
          JOptionPane.showMessageDialog(this, "Bienvenido "+ currentProfessor.getName() , "Bienvenido",
                    JOptionPane.INFORMATION_MESSAGE);
          this.dispose();
          ProfessorWindow p = new ProfessorWindow();
          p.setVisible(true);
        }else if(StudentTableModel.studentsList.loginSerch(carneTxt.getText(), password)){
            currentStudent = StudentTableModel.studentsList.getStudentByCarnet(carneTxt.getText());
            JOptionPane.showMessageDialog(this, "Bienvenido "+ currentStudent.getName() , "Bienvenido",
                    JOptionPane.INFORMATION_MESSAGE);
          this.dispose();

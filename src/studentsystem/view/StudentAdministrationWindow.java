 ...
 * @author Omar
 */
public class StudentAdministrationWindow extends javax.swing.JFrame {
    ...
    public StudentAdministrationWindow() {
        ...
        ProfessorTable.addMouseListener(new MouseListener(){
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                selected = fila;
                try {
                    editS = StudentTableModel.studentsList.getStudentAt(fila+1);
                } catch (Exception ex) {
                    Logger.getLogger(StudentAdministrationWindow.class.getName()).log(Level.SEVERE, null, ex);
                }
                addBtn.setEnabled(false);
                carneTxt.setText(editS.getCarnet());
                nameTxt.setText(editS.getName());
                cuiTxt.setText(String.valueOf(editS.getCUI()));
                emailTxt.setText(editS.getEmail());
                addressTxt.setText(editS.getAddress());
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        try{
            StudentTableModel.studentsList.addToFinal(carneTxt.getText(),0, numeroRandom.getPassword(carneTxt.getText()), "Estudiante",
       nameTxt.getText(), cuiTxt.getText(), emailTxt.getText(), addressTxt.getText());
            JOptionPane.showMessageDialog(this, "Estudiante agregado correctamente", "Agregado",
                    JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            StudentAdministrationWindow n = new StudentAdministrationWindow();
            n.setVisible(true);
        }catch(Exception ex){
        JOptionPane.showMessageDialog(this, "Hubo un error al agregar el estudiante, por favor inténtelo de nuevo", "Error",
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        try{
            StudentTableModel.studentsList.edit(selected+1, carneTxt.getText(), numeroRandom.getPassword(carneTxt.getText()), "Estudiante",
       nameTxt.getText(), cuiTxt.getText(), emailTxt.getText(), addressTxt.getText());
            JOptionPane.showMessageDialog(this, "Estudiante editado correctamente", "Editado",
                    JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            StudentAdministrationWindow n = new StudentAdministrationWindow();
            n.setVisible(true);
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, "Hubo un error al editar el estudiante, por favor inténtelo de nuevo", "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void deletedBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletedBtnActionPerformed
       try{
           StudentTableModel.studentsList.delete(selected+1);
           JOptionPane.showMessageDialog(this, "Estudiante eliminado correctamente", "Eliminado",
                    JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            StudentAdministrationWindow n = new StudentAdministrationWindow();
            n.setVisible(true);
       }catch(Exception e){
           JOptionPane.showMessageDialog(this, "Hubo un error al eliminar el estudiante, por favor inténtelo de nuevo", "Error",
                    JOptionPane.ERROR_MESSAGE);
       }
    ...
    private void massiveDataLoadBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_massiveDataLoadBtnActionPerformed
        try {
            archive.read("C:\\Users\\Omar\\Desktop\\StudentSystem\\src\\archive\\estudiantes.ipcb", "Estudiante");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentAdministrationWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentAdministrationWindow().setVisible(true);
            }
        });
    }
